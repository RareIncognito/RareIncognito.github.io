 ...
 */
function makeApple() {
  // TODO 4b-1: Fill in the makeApple codeblock   
...
function calculateHighScore() {// retrieve the high score from session storage if it exists, or set it to 0
